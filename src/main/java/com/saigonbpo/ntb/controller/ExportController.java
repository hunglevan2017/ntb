...
public class ExportController {
	...
	public ModelAndView getExcel(@PathVariable("tauid") int tauid,HttpServletResponse response)
		...
		if (ship != null) {
			...
			fis = classloader.getResourceAsStream("template/Crewlist.xlsx");
			...
			FuncUtil.setCellValH(ship.get("ten") != null ? ship.get("ten").toString():"", sheet, tempRow, tempCol,null);
			FuncUtil.setCellValH(ship.get("IMO") != null ? ship.get("IMO").toString():"", sheet, tempRow, tempCol+4,null);
			FuncUtil.setCellValH(ship.get("callsign") != null ? ship.get("callsign").toString():"", sheet, tempRow, (tempCol+4*2),null);
